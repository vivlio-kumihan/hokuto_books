...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'info@hokutoshobo.jp';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'http://www.hokutoshobo.jp/book/order/thanks/';

#08.設置者に届くメールの件名
$conf{'subject'} = 'ホームページより自費出版ご購入お申し込みがありました';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '自費出版ご購入お申し込みありがとうございます';
