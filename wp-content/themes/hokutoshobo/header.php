...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="http://localhost:8888/hokuto-bs/common/css/page.css" />
  <link rel="stylesheet" type="text/css" href="http://localhost:8888/hokuto-bs/common/css/print.css" media="print" />
  <link rel="stylesheet" type="text/css" href="http://localhost:8888/hokuto-bs/common/css/fontMiddle.css" id="fontsize" />
  <link rel="stylesheet" type="text/css" href="http://localhost:8888/hokuto-bs/common/css/global.css" />
  <?php
  // ブログIDの取得
  global $blog_id;
  if ($blog_id == 2) : ?>
    <link rel="stylesheet" type="text/css" href="http://localhost:8888/hokuto-bs/common/css/smoothness/jquery-ui.css" />
  <?php else: ?>
    <link rel="stylesheet" type="text/css" href="http://localhost:8888/hokuto-bs/common/css/smoothness/jquery-ui-1.8.16.custom.css" />
  <?php endif; ?>
  <meta name="author" content="" />
  <meta name="version" content="12.07.20" />
  <link rel="contents" href="http://localhost:8888/hokuto-bs" title="ホーム" />
  ...
  <?php if (is_home()): ?>
    <!--[if lte IE 6]>  
<script type="textlocalhost:8888/hokuto-bs/common/js/DD_belatedPNG.js">  
</script>  
  ...
  <?php elseif ($blog_id == 2) : ?>
    ...
    <?php elseif ($blog_id == 3) : ?>
      ...
      <div id="Header">
        ...
        <p class="logo"><a href="http://localhost:8888/hokuto-bs"><img src="http://localhost:8888/hokuto-bs/common/img/logo.png" alt="<?php bloginfo('name'); ?>" /></a></p>
        <div class="headInfo">
      ...
      <div id="Menu">
        <ul>
          <li class="menuTop"><a href="http://localhost:8888/hokuto-bs/">ホーム</a></li>
          ...
          <li class="menu08"><a href="http://localhost:8888/hokuto-bs/process/">自費出版制作の流れ</a></li>
          <li class="menu04"><a href="http://localhost:8888/hokuto-bs/knowledge/">豆知識</a></li>
