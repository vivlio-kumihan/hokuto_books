...
<head>
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-0MJDVB9MJ6"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-0MJDVB9MJ6');
  </script>
  <meta charset="UTF-8">
        ...
        <div class="header-others">
          ...
          <div class="header-others__lower">
            <form id="search-form" class="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
              <input class="search__input" type="text" name="s" placeholder="キーワードを入力" />
              <input class="search__submit-btn" type="submit" value="検索" />
            </form>
          </div>
        </div>
      </div>
