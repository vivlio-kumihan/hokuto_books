    ...
    $categories = get_the_category();
        foreach($categories as $category)
          if(cat_is_ancestor_of(10, $category))
             echo ''.$category->cat_name.' ';
?></p>
          <div class="price <?php echo post_custom('book_order'); ?>"><div class="btOrder"><img src="http://localhost:8888/hokuto-bs/common/img/bt-order-s.png" alt="販売中" /></div><div class="soldOut">絶版</div><div class="amazon"><img src="http://localhost:8888/hokuto-bs/common/img/bt-order-a.png" alt="アマゾンで販売中" width="69" height="20" /></div></div>
        </dd>
      </dl>
      <?php endwhile; endif; ?>
    </div>
