          ...
          <div class="bookInfo">
            <dl>
              ...
              <dd class="authorName <?php echo post_custom('author_summary'); ?>">
                ...
                <div class="authorSummary"><a href="http://localhost:8888/hokuto-bs/book/author-summary/<?php
                                                                                                        $categories = get_the_category();
                                                                                                        foreach ($categories as $category)
                                                                                                          if (cat_is_ancestor_of(8, $category))
...
">著者略歴</a></div>
            ...
            <dl>
              <dt>価格</dt>
              <dd class="price <?php echo post_custom('book_order'); ?>"><?php echo post_custom('book_price'); ?><?php echo post_custom('price_tax'); ?> <div class="btOrder"><a href="http://localhost:8888/hokuto-bs/book/order/?title=<?php the_title(); ?>&price=<?php echo post_custom('book_price'); ?>"><img src="http://localhost:8888/hokuto-bs/common/img/bt-order.png" alt="ご購入" /></a></div>
