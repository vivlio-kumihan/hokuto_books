  ...
  <div class="main__contents-aside-wrapper">
    <div class="main__contents-wrapper">
      ...
      <div id="about-self-publishing" class="main__inner">
        ...
        <ul class="main__list">
          <li><a href="http://localhost:8888/hokuto-bs/news/259/">本を売るということ～書籍流通の仕組み</a></li>
          <li><a href="http://localhost:8888/hokuto-bs/news/266/">自費出版本が書店に並ぶには？</a></li>
          <li><a href="http://localhost:8888/hokuto-bs/news/276/">自費出版本を販売する方法</a></li>
        </ul>
